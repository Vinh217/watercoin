  ...
  [179],
  {
      ...
      let n = r(2347),
        o = function (e) {
          for (
            ...
            o[a - 1] = arguments[a];
          return (0, n.normalizePathTrailingSlash)(r(4995).addLocale(e, ...o));
        };
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
    ...
    4695: function (e, t, r) {
      ...
      let n = function () {
        for (var e = arguments.length, t = Array(e), n = 0; n < e; n++)
          t[n] = arguments[n];
        return r(7888).detectDomainLocale(...t);
      };
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
    ...
    2285: function (e, t, r) {
      ...
      async function $(e) {
        ...
        {
          let { normalizeLocalePath: e } = r(3237),
            { detectDomainLocale: t } = r(7888),
            { parseRelativeUrl: n } = r(2494),
            { formatUrl: i } = r(3531);
          if (o.locales) {
            let r = n(a),
              l = e(r.pathname, o.locales);
            l.detectedLocale
              ? ((r.pathname = l.pathname), (a = i(r)))
              : (p = o.locale);
      ...
      function J(e) {
        ...
        return (0, g.jsx)(Y, {
          ...
          children: (0, g.jsx)(B.AppRouterContext.Provider, {
            value: o,
          ...
          i
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                ...
                es({ ...e, err: l, Component: u, styleSheets: s, props: t })
              );
            })
        );
      }
          ...
          !(function (e, t) {
            ...
            en
              ...
              : ((en = b.default.hydrateRoot(e, r, {
                ...
                (eo = !1));
          })(l, (e) => (0, g.jsx)(eu, { callbacks: [e, p], children: m })),
          h
        );
      }
      async function ec(e) {
    ...
    9185: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(4985);
      let n = r(2285);
      (window.next = {
        version: n.version,
        get router() {
    ...
    7461: function (e, t, r) {
      ...
      let n = r(1351)._(r(5271)).default.createContext({});
    },
    6007: function (e, t) {
      "use strict";
      function r(e) {
      ...
      class Y {
        ...
        async change(e, t, r, n, o) {
          ...
          let J = X.locale;
          {
            ...
            o.detectedLocale &&
              ((X.locale = o.detectedLocale),
              (e.pathname = (0, S.addBasePath)(e.pathname)),
              (r = (0, g.formatWithValidation)(e)),
              (t = (0, S.addBasePath)(
                (0, c.normalizeLocalePath)(
                  (0, w.hasBasePath)(t) ? (0, E.removeBasePath)(t) : t,
                  this.locales
                ).pathname
              )));
            let a = !1;
            (null == (f = this.locales) ? void 0 : f.includes(X.locale)) ||
              ((e.pathname = (0, P.addLocale)(e.pathname, X.locale)),
              V({ url: (0, g.formatWithValidation)(e), router: this }),
              (a = !0));
            ...
            if (
              ...
              V({
                url:
                  ...
                  i.domain +
                  (0, S.addBasePath)(
                    (X.locale === i.defaultLocale ? "" : "/" + X.locale) +
                      ("/" === e ? "" : e) || "/"
                  ),
                router: this,
              }),
          ...
          this._inFlightRoute &&
            this.clc &&
            (K ||
              Y.events.emit("routeChangeError", N(), this._inFlightRoute, ee),
            this.clc(),
            (this.clc = null)),
            (r = (0, S.addBasePath)(
              (0, P.addLocale)(
          ...
          if (!G && this.onlyAHashChange(et) && !er) {
            (X.asPath = et),
              Y.events.emit("hashChangeStart", r, ee),
            ...
            try {
              ...
              throw (
                ((0, u.default)(e) &&
                  e.cancelled &&
                  Y.events.emit("routeChangeError", e, et, ee),
                e)
              );
            }
            return Y.events.emit("hashChangeComplete", r, ee), !0;
          }
          let en = (0, p.parseRelativeUrl)(t),
            { pathname: eo, query: ea } = en;
          try {
          ...
          let es = !!(
              ...
              (!(0, h.isDynamicRoute)(el) ||
                !(0, m.getRouteMatcher)((0, _.getRouteRegex)(el))(eu))
            ),
            ec =
              !n.shallow &&
          ...
          if (
            ...
            z &&
              ...
              en.pathname === eo ||
                ((eo = en.pathname),
                (en.pathname = (0, S.addBasePath)(eo)),
                ec || (t = (0, g.formatWithValidation)(en)))),
            !(0, M.isLocalURL)(r))
          )
            return V({ url: r, router: this }), !1;
          (ei = (0, v.removeLocale)((0, E.removeBasePath)(ei), X.locale)),
            (el = (0, a.removeTrailingSlash)(eo));
          let ef = !1;
          if ((0, h.isDynamicRoute)(el)) {
            let e = (0, p.parseRelativeUrl)(ei),
              n = e.pathname,
              o = (0, _.getRouteRegex)(el);
            ef = (0, m.getRouteMatcher)(o)(n);
            let a = el === n,
              i = a ? (0, A.interpolateAs)(el, n, ea) : {};
            if (ef && (!a || i.result))
              a
                ? (r = (0, g.formatWithValidation)(
                    Object.assign({}, e, {
                      pathname: i.result,
                      query: (0, I.omit)(ea, i.params),
                    })
                  ))
                : Object.assign(ea, ef);
            else {
              let e = Object.keys(o.groups).filter(
                (e) => !ea[e] && !o.groups[e].optional
              );
              if (e.length > 0 && !ec)
                throw Error(
                  (a
          ...
          G || Y.events.emit("routeChangeStart", r, ee);
          ...
          try {
            ...
            if (
              ...
              (el = eo = a.route || el),
                ee.shallow || (ea = Object.assign({}, a.query || {}, ea));
              let e = (0, w.hasBasePath)(en.pathname)
                ? (0, E.removeBasePath)(en.pathname)
                : en.pathname;
              if (
                (ef &&
                  eo !== e &&
            ...
            let s = n.shallow && X.route === (null != (T = a.route) ? T : el),
              f = null != (C = n.scroll) ? C : !G && !s,
              d = null != o ? o : f ? { x: 0, y: 0 } : null,
              g = {
                ...X,
                route: el,
                pathname: eo,
            ...
            if (G && ed) {
              ...
              "/_error" === this.pathname &&
                (null == (k = self.__NEXT_DATA__.props)
                  ...
                  ? void 0
                  : L.statusCode) === 500 &&
                (null == (U = a.props) ? void 0 : U.pageProps) &&
                (a.props.pageProps.statusCode = 500);
              try {
                await this.set(g, a, d);
              } catch (e) {
                throw (
                  ((0, u.default)(e) &&
                    e.cancelled &&
            ...
            if (
              (Y.events.emit("beforeHistoryChange", r, ee),
              ...
              !(
                ...
                !$ &&
                !er &&
                (0, x.compareRouterStates)(g, this.state)
              ))
            ) {
              try {
                await this.set(g, a, d);
              ...
              if (a.error)
                throw (
                  (G || Y.events.emit("routeChangeError", a.error, et, ee),
                  a.error)
                );
              X.locale && (document.documentElement.lang = X.locale),
                G || Y.events.emit("routeChangeComplete", r, ee),
        ...
        (L = function (e) {
          e.forEach(function (e) {
            e.interactionId &&
              ...
              (C = (A = Math.max(A, e.interactionId)) ? (A - I) / 7 + 1 : 0));
          });
        }),
        (N = function () {
        ...
        (W = function (e, t) {
          ...
          var n,
            ...
            a = function (e) {
              ...
              var t,
                r = ((t = Math.min(F.length - 1, Math.floor(B() / 50))), F[t]);
              r &&
                r.latency !== o.value &&
